...
So the code may have several bugs or wrong implementations, therefore don't trust this code too much.
Currently I am not managing this code well please open pull requests if you find bugs in the code and want to fix.
